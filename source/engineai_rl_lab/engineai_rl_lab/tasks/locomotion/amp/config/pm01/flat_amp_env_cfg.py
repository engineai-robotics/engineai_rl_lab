...
class PM01AMPFlatEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.arm_pitch_position.weight = 0.3
        self.rewards.arm_roll_position.weight = 0.3
        self.rewards.arm_yaw_position.weight = 0.3
        ...
        self.rewards.feet_slide.weight = -1.0   #-0.3
        self.rewards.dof_vel.weight = -1.0e-5
        self.rewards.dof_acc.weight = -1.25e-8
        self.rewards.action_rate.weight = -0.03
        self.rewards.action_smoothness.weight = -0.06
        self.rewards.dof_torque.weight = -1.0e-6
